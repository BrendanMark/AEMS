...
namespace AEMS
{
    ...
    {
        String SqlConnectString = "server=np-stem.temple.edu;Database=CIS4396F01;User id=usrCIS4396F01;Password=transFormer85";       // for colg
        //String SqlConnectString = "server=127.0.0.1,5555;Database=sp15_3342_tuf15070;User id=tuf15070;Password=Woo8ohma";       // for home
