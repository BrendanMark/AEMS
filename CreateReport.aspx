<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateReport.aspx.cs" Inherits="AEMS.CreateReport" %>
...
<body>
    ...
    <%--  Code for navigation bar--%>
        ...
        <%-- Code for navigation bar ends--%> <%--Code for the panel containing search and gridview--%>
        <div class="container">           
            <div class="col-lg-12">
